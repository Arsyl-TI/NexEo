...
import { $fetch as $fetch$1 } from "D:/MyProject/NexEo/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "D:/MyProject/NexEo/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/MyProject/NexEo/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "D:/MyProject/NexEo/node_modules/.pnpm/h3@1.15.11/node_modules/h3/dist/index.mjs";
import { shouldHydrate, setActivePinia, createPinia } from "pinia";
import { defu } from "D:/MyProject/NexEo/node_modules/.pnpm/defu@6.1.7/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "D:/MyProject/NexEo/node_modules/.pnpm/ufo@1.6.4/node_modules/ufo/dist/index.mjs";
...
const unhead_ZSxQRa6jF7ZM2nEQqvgJkRXEdZVLaY7w8e5L8i3E_Lw = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BjNJ4pXK.js")
  },
  {
    name: "share",
    path: "/share",
  ...
  },
  {
    name: "library",
    path: "/library",
    component: () => import("./_nuxt/library-t77TT1Uc.js")
  },
  {
    name: "video-id",
    path: "/video/:id()",
    component: () => import("./_nuxt/_id_-DVH7pDgr.js")
  },
  {
    name: "manga",
    path: "/manga",
    component: () => import("./_nuxt/index-B1j4W6cS.js")
  },
  {
    name: "novels",
    path: "/novels",
  ...
  },
  {
    name: "novel-browser",
    path: "/novel-browser",
    component: () => import("./_nuxt/novel-browser-NdZC1hGE.js")
  },
  {
    name: "downloader",
    path: "/downloader",
    component: () => import("./_nuxt/index-Sp-7vlYN.js")
  },
  {
    name: "manga-slug",
    path: "/manga/:slug()",
    component: () => import("./_nuxt/index-CrGzZAvu.js")
  },
  {
    name: "novels-slug",
    path: "/novels/:slug()",
    component: () => import("./_nuxt/index-0YvO4Eaa.js")
  },
  {
    name: "manga-slug-chapter",
    path: "/manga/:slug()/:chapter()",
    component: () => import("./_nuxt/_chapter_-u3eNpjUj.js")
  },
  {
    name: "novels-slug-chapter",
    path: "/novels/:slug()/:chapter()",
    component: () => import("./_nuxt/_chapter_-D0zaP-Cn.js")
  }
];
...
const revive_payload_server_8ag9zyICEcrlNgI9u15tGTtIqU0f_o7v7KUJcMCIXro = /* @__PURE__ */ defineNuxtPlugin({
...
const pinia_Ab1D_QMMf_egrzVdVYpZ5xs6QSwaKU60pkFvRWVq_9Y = /* @__PURE__ */ defineNuxtPlugin(() => {
});
const plugins = [
  payloadPlugin,
  unhead_ZSxQRa6jF7ZM2nEQqvgJkRXEdZVLaY7w8e5L8i3E_Lw,
  plugin$1,
  revive_payload_server_8ag9zyICEcrlNgI9u15tGTtIqU0f_o7v7KUJcMCIXro,
  plugin,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-o5-Wfmkr.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-5hYAtzei.js"));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.11_@oxc-project+t_3a6e6a4a92f6df0081e292eb4e7a9fff/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.11_@oxc-project+t_3a6e6a4a92f6df0081e292eb4e7a9fff/node_modules/nuxt/dist/app/components/nuxt-root.vue");
