      ...
      if (loading.value) {
        ...
        if (showYtModal.value) {
          ...
          if (ytMeta.value) {
            ...
            _push(`<div class="min-w-0 flex-1" data-v-d6a6b59a><h4 class="font-bold text-sm text-foreground line-clamp-2 leading-tight mb-1" data-v-d6a6b59a>${ssrInterpolate(ytMeta.value.title)}</h4><p class="text-xs text-purple-400 font-semibold mb-1" data-v-d6a6b59a>👤 ${ssrInterpolate(ytMeta.value.author)}</p><span class="inline-block px-2.5 py-0.5 rounded-full bg-card border border-border text-[11px] text-muted-foreground font-mono" data-v-d6a6b59a> ⏱️ ${ssrInterpolate(ytMeta.value.durationFormatted)}</span></div></div>`);
        ...
        if (categoryId.value && !selectedFolder.value) {
          ...
          ssrRenderList(unref(videoStore).categories, (cat) => {
            _push(`<div class="cursor-pointer group glass-card-hover p-6 shadow-xl" data-v-d6a6b59a><div class="flex items-center gap-4" data-v-d6a6b59a><div class="w-14 h-14 rounded-2xl bg-primary/15 border border-primary/30 text-primary flex items-center justify-center text-3xl group-hover:scale-110 transition-transform" data-v-d6a6b59a>${ssrInterpolate(cat.id === "anime" ? "🍿" : cat.id === "youtube" ? "🎬" : "🎥")}</div><div data-v-d6a6b59a><h3 class="font-bold text-xl text-foreground group-hover:text-primary transition-colors" data-v-d6a6b59a>${ssrInterpolate(cat.name)}</h3><p class="text-xs text-muted-foreground mt-1 font-mono" data-v-d6a6b59a>${ssrInterpolate(cat.path)}</p><span class="inline-block mt-2 text-[11px] bg-primary/15 text-primary border border-primary/30 px-3 py-0.5 rounded-full font-bold" data-v-d6a6b59a>${ssrInterpolate(cat.videoCount ?? 0)} Total Video </span></div></div></div>`);
          });
          _push(`<!--]--></div></section>`);
        }
        _push(`</div>`);
...
//# sourceMappingURL=index-C3mfIvL_.js.map
