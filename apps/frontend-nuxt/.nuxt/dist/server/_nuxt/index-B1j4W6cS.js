...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "manga-catalog min-h-screen pb-16" }, _attrs))} data-v-2b9d4547><div class="max-w-6xl mx-auto px-3 sm:px-6 pt-4" data-v-2b9d4547><div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8" data-v-2b9d4547><div data-v-2b9d4547><h1 class="text-3xl font-extrabold text-foreground tracking-tight flex items-center gap-3" data-v-2b9d4547><span data-v-2b9d4547>🎨</span> Koleksi Manga &amp; Komik </h1><p class="text-xs text-muted-foreground mt-1" data-v-2b9d4547>Pembaca komik digital lokal (Webtoon &amp; Manga Mode) dalam jaringan LAN</p></div><div class="relative w-full sm:w-72" data-v-2b9d4547><input${ssrRenderAttr("value", searchQuery.value)} type="text" placeholder="Cari judul komik..." class="w-full bg-background border border-border rounded-xl pl-9 pr-4 py-2 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary" data-v-2b9d4547><span class="absolute left-3 top-2.5 text-xs text-muted-foreground" data-v-2b9d4547>🔍</span></div></div>`);
      if (unref(mangaStore).loading) {
        ...
        _push(`<div class="text-center py-20 bg-card/40 border border-border rounded-3xl p-8" data-v-2b9d4547><div class="text-4xl mb-3" data-v-2b9d4547>🎨</div><h3 class="text-base font-bold text-foreground mb-1" data-v-2b9d4547>Belum Ada Komik Tersedia</h3><p class="text-xs text-muted-foreground max-w-md mx-auto leading-relaxed" data-v-2b9d4547> Simpan folder komik/manga Anda di folder <code data-v-2b9d4547>data/manga/[slug]/[chapter]</code> pada disk server untuk mulai membaca! </p></div>`);
      } else {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                if (item.cover) {
                  ...
                  _push2(`<div class="flex flex-col items-center justify-center w-full h-full text-xs text-muted-foreground p-4 text-center" data-v-2b9d4547${_scopeId}><span class="text-2xl mb-1" data-v-2b9d4547${_scopeId}>🎨</span><span data-v-2b9d4547${_scopeId}>No Cover</span></div>`);
                }
                ...
                if (item.author) {
                  _push2(`<p class="text-[11px] text-muted-foreground truncate" data-v-2b9d4547${_scopeId}> 👤 ${ssrInterpolate(item.author)}</p>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
                  ...
                  createVNode("div", null, [
                    createVNode("div", { class: "aspect-[2/3] rounded-xl overflow-hidden bg-card border border-border/80 mb-3 relative shadow-md group-hover:shadow-xl transition-all" }, [
                      item.cover ? (openBlock(), createBlock("img", {
                        ...
                        createVNode("span", { class: "text-2xl mb-1" }, "🎨"),
                    ...
                    }, " 👤 " + toDisplayString(item.author), 1)) : createCommentVNode("", true)
                  ])
                ];
              }
            }),
...
//# sourceMappingURL=index-B1j4W6cS.js.map
