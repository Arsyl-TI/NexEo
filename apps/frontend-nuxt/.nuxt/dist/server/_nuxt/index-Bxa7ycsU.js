    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        if (novel.value.cover) {
          ...
          _push(`<div class="flex flex-col items-center justify-center h-full text-muted-foreground text-xs p-4 text-center" data-v-5259d09c><span data-v-5259d09c>📖</span><span class="mt-2" data-v-5259d09c>No Cover Available</span></div>`);
        }
        ...
        if (hasResumeChapter.value) {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span data-v-5259d09c${_scopeId}>📖</span> Mulai Membaca `);
              } else {
                return [
                  createVNode("span", null, "📖"),
        ...
        if (novel.value.author) {
          _push(`<div class="inline-flex items-center gap-2 bg-purple-900/30 border border-purple-500/30 text-purple-300 px-3.5 py-1.5 rounded-full font-medium" data-v-5259d09c><span data-v-5259d09c>👤</span> Author: <span class="font-bold text-white" data-v-5259d09c>${ssrInterpolate(novel.value.author)}</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="inline-flex items-center gap-2 bg-card/80 border border-border text-muted-foreground px-3.5 py-1.5 rounded-full font-medium" data-v-5259d09c><span data-v-5259d09c>🌐</span> Bahasa: <span class="text-foreground font-semibold" data-v-5259d09c>Indonesia / English</span></div></div>`);
        ...
        if (activeTab.value === "chapters") {
                ...
                default: withCtx((_, _push2, _parent2, _scopeId) => {
                  if (_push2) {
                    ...
                    if (novel.value.cover) {
                      ...
                      _push2(`<div class="w-full h-full flex items-center justify-center text-[10px]" data-v-5259d09c${_scopeId}>📖</div>`);
                    }
          ...
          _push(`<div class="bg-card/70 border border-border/80 rounded-2xl p-6 shadow-xl backdrop-blur-xl" data-v-5259d09c><h2 class="text-lg font-bold text-foreground mb-4 flex items-center gap-2" data-v-5259d09c><span data-v-5259d09c>📄</span> Sinopsis Novel </h2><div class="prose prose-invert max-w-none text-muted-foreground leading-relaxed text-sm" data-v-5259d09c>${(novel.value.description || "Tidak ada sinopsis resmi untuk novel ini.") ?? ""}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
      ...
      if (showBatchTransModal.value) {
        ...
        _push(`<div class="bg-purple-950/30 border border-purple-500/30 rounded-xl p-3.5 text-xs text-purple-300 leading-relaxed" data-v-5259d09c> 💡 Teks terjemahan akan ditulis langsung ke file disk <code data-v-5259d09c>.txt</code> seluruh chapter novel. </div></div><div class="flex gap-3" data-v-5259d09c><button class="flex-1 px-4 py-2.5 rounded-xl border border-border text-xs font-medium text-muted-foreground hover:text-foreground" data-v-5259d09c> Batal </button><button${ssrIncludeBooleanAttr(isBatchTranslating.value) ? " disabled" : ""} class="flex-1 btn-primary py-2.5 text-xs font-bold flex items-center justify-center gap-2 shadow-lg disabled:opacity-50" data-v-5259d09c>`);
...
//# sourceMappingURL=index-Bxa7ycsU.js.map
