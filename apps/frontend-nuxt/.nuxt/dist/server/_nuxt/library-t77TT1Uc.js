...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "library-page min-h-screen pb-16" }, _attrs))} data-v-eaaa2912><div class="max-w-6xl mx-auto px-4 sm:px-6 pt-4" data-v-eaaa2912><div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8" data-v-eaaa2912><div data-v-eaaa2912><h1 class="text-3xl font-extrabold text-foreground tracking-tight flex items-center gap-3" data-v-eaaa2912><span data-v-eaaa2912>📚</span> Pustaka &amp; Riwayat Baca Saya </h1><p class="text-xs text-muted-foreground mt-1" data-v-eaaa2912>Kelola novel favorit dan lacak progres bab novel yang sedang dibaca</p></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-eaaa2912${_scopeId}>📖</span> Jelajahi Koleksi Novel `);
          } else {
            return [
      ...
      if (loading.value) {
        ...
        if (filteredHistory.value.length === 0) {
          _push(`<div class="text-center py-20 bg-card/40 border border-border/60 rounded-3xl p-8" data-v-eaaa2912><div class="text-4xl mb-3" data-v-eaaa2912>📖</div><h3 class="text-base font-bold text-foreground mb-1" data-v-eaaa2912>Belum Ada Riwayat Baca</h3><p class="text-xs text-muted-foreground mb-6" data-v-eaaa2912>Setiap bab novel yang Anda baca akan otomatis tercatat di sini!</p>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: "/novels",
          ...
          ssrRenderList(filteredHistory.value, (item) => {
            ...
            if (item.cover) {
              ...
              _push(`<div class="w-full h-full flex items-center justify-center text-xs" data-v-eaaa2912>📖</div>`);
            }
            _push(`</div><div class="min-w-0" data-v-eaaa2912><h4 class="font-bold text-sm text-foreground truncate mb-1" data-v-eaaa2912>${ssrInterpolate(item.title)}</h4><p class="text-xs text-amber-400 font-mono font-semibold mb-1" data-v-eaaa2912> 📍 Terakhir: ${ssrInterpolate(item.lastChapterTitle || item.lastChapter)}</p>`);
            _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        if (filteredBookmarks.value.length === 0) {
          _push(`<div class="text-center py-20 bg-card/40 border border-border/60 rounded-3xl p-8" data-v-eaaa2912><div class="text-4xl mb-3" data-v-eaaa2912>📌</div><h3 class="text-base font-bold text-foreground mb-1" data-v-eaaa2912>Koleksi Favorit Kosong</h3><p class="text-xs text-muted-foreground mb-6" data-v-eaaa2912>Tandai novel favorit Anda saat membuka detail novel untuk menyimpannya di sini.</p>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: "/novels",
            class: "btn-primary px-5 py-2.5 text-xs font-bold inline-flex items-center gap-2"
          }, {
            ...
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  ...
                  if (novel.author) {
                    _push2(`<p class="text-[11px] text-muted-foreground truncate" data-v-eaaa2912${_scopeId}>👤 ${ssrInterpolate(novel.author)}</p>`);
                  } else {
                    _push2(`<!---->`);
                  }
...
//# sourceMappingURL=library-t77TT1Uc.js.map
