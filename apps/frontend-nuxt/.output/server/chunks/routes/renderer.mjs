...
import { n as joinRelativeURL, u as useRuntimeConfig, o as encodePath, p as defineRenderHandler, m as getQuery, e as createError, q as getRouteRules, v as getResponseStatusText, w as getResponseStatus, b as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Personal LAN video streaming and novel reader with AI translation"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"title":"NexEo — Personal LAN Streaming & Premium Novel Reader"};
...
const entryIds = ["../../node_modules/.pnpm/nuxt@3.21.11_@oxc-project+t_3a6e6a4a92f6df0081e292eb4e7a9fff/node_modules/nuxt/dist/app/entry.js"];
