    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!immersive.value && !loading.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` \u{1F4CB} <span class="hidden sm:inline" data-v-cd33a977${_scopeId}>Daftar Bab</span>`);
            } else {
              return [
      ...
      if (loading.value) {
        ...
        _push(`<article class="${ssrRenderClass(["prose max-w-none rounded-2xl p-4 sm:p-8 md:p-12 border shadow-lg leading-relaxed", themeClasses.value.reader])}" style="${ssrRenderStyle({ fontSize: `${unref(uiStore).readerFontSize}px` })}" data-v-cd33a977>${(_a = renderedHtml.value) != null ? _a : ""}</article>`);
      }
...
//# sourceMappingURL=_chapter_-Yp9CtV5s.mjs.map
