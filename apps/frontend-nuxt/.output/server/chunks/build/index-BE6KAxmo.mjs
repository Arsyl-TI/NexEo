    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        if (novel.value.cover) {
          ...
          _push(`<div class="flex flex-col items-center justify-center h-full text-muted-foreground text-xs p-4 text-center" data-v-050cd33f><span data-v-050cd33f>\u{1F4D6}</span><span class="mt-2" data-v-050cd33f>No Cover Available</span></div>`);
        }
        ...
        if (hasResumeChapter.value) {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span data-v-050cd33f${_scopeId}>\u{1F4D6}</span> Mulai Membaca `);
              } else {
                return [
        ...
        if (novel.value.author) {
          _push(`<div class="inline-flex items-center gap-2 bg-purple-900/30 border border-purple-500/30 text-purple-300 px-3.5 py-1.5 rounded-full font-medium" data-v-050cd33f><span data-v-050cd33f>\u{1F464}</span> Author: <span class="font-bold text-white" data-v-050cd33f>${ssrInterpolate(novel.value.author)}</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="inline-flex items-center gap-2 bg-card/80 border border-border text-muted-foreground px-3.5 py-1.5 rounded-full font-medium" data-v-050cd33f><span data-v-050cd33f>\u{1F310}</span> Bahasa: <span class="text-foreground font-semibold" data-v-050cd33f>Indonesia / English</span></div></div>`);
                ...
                default: withCtx((_, _push2, _parent2, _scopeId) => {
                  if (_push2) {
                    ...
                    if (novel.value.cover) {
                      ...
                      _push2(`<div class="w-full h-full flex items-center justify-center text-[10px]" data-v-050cd33f${_scopeId}>\u{1F4D6}</div>`);
                    }
...
//# sourceMappingURL=index-BE6KAxmo.mjs.map
