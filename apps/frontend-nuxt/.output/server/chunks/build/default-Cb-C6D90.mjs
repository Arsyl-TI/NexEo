...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "fixed top-0 left-0 right-0 z-50 flex h-12 items-center justify-between px-4 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-gray-800 shadow-lg" }, _attrs))} data-v-4c40a12b><div class="flex items-center space-x-5" data-v-4c40a12b>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-4c40a12b${_scopeId}>\u26A1</span> NexEo `);
          } else {
            return [
      ...
      _push(`<nav class="hidden md:flex items-center space-x-1 text-xs font-semibold" data-v-4c40a12b>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`\u{1F4DA} Novels`);
          } else {
            return [
              createTextVNode("\u{1F4DA} Novels")
            ];
          }
        }),
        _: 1
      ...
      _push(`</nav></div><div class="flex items-center space-x-3" data-v-4c40a12b>`);
      if (lanUrl.value) {
        _push(`<div class="cursor-pointer bg-primary/10 border border-primary/30 text-primary hover:bg-primary/20 px-3 py-1 rounded-full text-xs font-mono font-bold flex items-center gap-1.5 transition-all shadow-sm" title="Klik untuk menyalin alamat IP LAN untuk perangkat HP / Komputer lain" data-v-4c40a12b><span class="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" data-v-4c40a12b></span><span data-v-4c40a12b>\u{1F4E1} ${ssrInterpolate(lanUrl.value)}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button class="p-1.5 rounded-lg hover:bg-gray-800 text-gray-400 hover:text-white transition-colors" data-v-4c40a12b>`);
      if (!isDark.value) {
        _push(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-4c40a12b><path d="M12 3v1m0 16v1m8.66-10H19m-4.34 5.66l1.42 1.42M6.34 6.34l1.42 1.42M3 12h1m19 0h-1M6.34 17.66l1.42-1.42" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" data-v-4c40a12b></path></svg>`);
      } else {
        _push(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-4c40a12b><path d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" data-v-4c40a12b></path></svg>`);
      }
...
const Navbar = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-4c40a12b"]]);
...
//# sourceMappingURL=default-Cb-C6D90.mjs.map
