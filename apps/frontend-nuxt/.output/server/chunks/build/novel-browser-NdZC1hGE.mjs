  ...
  setup(__props) {
    ...
    const filteredNovels = computed(() => {
      const validNovels = novelList.value.filter((n) => {
        const title = typeof (n == null ? void 0 : n.title) === "string" ? n.title.trim() : "";
        const slug = typeof (n == null ? void 0 : n.slug) === "string" ? n.slug.trim() : "";
    ...
    computed(() => {
      var _a, _b;
      return ((_b = (_a = selectedNovelDetail.value) == null ? void 0 : _a.chapters) == null ? void 0 : _b.length) || 0;
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (selectedNovelDetail.value || isLoadingDetail.value) {
        ...
        if ((_a = selectedNovelDetail.value) == null ? void 0 : _a.cover) {
        ...
        if (isLoadingDetail.value) {
          ...
          if ((_b = selectedNovelDetail.value.tags) == null ? void 0 : _b.length) {
          ...
          if (selectedNovelDetail.value.sourceUrl) {
            _push(`<a${ssrRenderAttr("href", selectedNovelDetail.value.sourceUrl)} target="_blank" class="flex-1 px-4 py-2 bg-card text-card-foreground rounded-lg hover:bg-border transition-colors text-sm font-medium flex items-center justify-center"> Buka Sumber \xE2\u2020\u2014 </a>`);
          } else {
            _push(`<!---->`);
          }
          ...
          if (detailTab.value === "synopsis") {
            ...
            _push(`<section class="bg-card/40 rounded-xl p-6 max-h-[50vh] overflow-y-auto"><div class="flex items-center justify-between mb-4"><h2 class="text-lg font-bold text-foreground">Daftar Bab</h2><div class="text-xs text-muted-foreground">${ssrInterpolate(((_c = selectedNovelDetail.value.chapters) == null ? void 0 : _c.length) || 0)} bab tersedia</div></div>`);
            if (!selectedNovelDetail.value.chapters || selectedNovelDetail.value.chapters.length === 0) {
              ...
              ssrRenderList(selectedNovelDetail.value.chapters, (ch) => {
                ...
                if (selectedNovelDetail.value.cover) {
                  ...
                  _push(`<div class="flex items-center justify-center h-full text-[9px] text-muted-foreground">\u{1F4D6}</div>`);
                }
...
//# sourceMappingURL=novel-browser-NdZC1hGE.mjs.map
