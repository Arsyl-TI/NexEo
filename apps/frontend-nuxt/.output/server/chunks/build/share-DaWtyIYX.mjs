...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><div class="relative w-full sm:w-64" data-v-2a783cba><input${ssrRenderAttr("value", searchQuery.value)} type="text" placeholder="Cari nama berkas..." class="w-full pl-9 pr-4 py-1.5 bg-background border border-border rounded-full text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary" data-v-2a783cba><span class="absolute left-3 top-2 text-xs text-muted-foreground" data-v-2a783cba>\u{1F50D}</span></div></div><div data-v-2a783cba>`);
      if (loading.value) {
...
//# sourceMappingURL=share-DaWtyIYX.mjs.map
